...
export default function Order() {
    ...
    return (
       ...
       <div className="picture_container order_picture_container">
            <div className="about_overlay"> 
                <marquee data-aos="fade-right" scrollamount={50}>ORDER NOW AND PAY WITH CARD</marquee> 
            </div> 
       </div>
        <div className="order_container" data-aos="fade-down">  
            <h2>Order Now</h2>
            <p>
            Choice Supermarket offers an easy and convenient way to order groceries and household essentials online. Customers can browse a wide range of products, including fresh produce, meats, dairy, and pantry staples, as well as personal care and cleaning items. Once items are added to the cart, the checkout process is simple and secure. Delivery and pickup options are typically available, making it easy to choose a method that fits your schedule. With competitive prices, frequent discounts, and reliable service, Choice Supermarket ensures that your shopping experience is hassle-free, whether in-store or online.
            </p>
