    ...
    return (
        <div className='home_delivery_container'>
            ...
            <div className="delivery_calculate" data-aos="fade-right">
                <select defaultValue={actualKm === '' ? 'Choose Region' : actualKm} onChange={(e) => {
                ...
                <input type="text" style={{ pointerEvents: 'none' }} placeholder="km/h" defaultValue={actualKm !== '' ? deliverylist[deliverylist.findIndex(item => item.region === actualKm)].km + 'km' : ''} />
                <button onClick={() => {
                    if (actualKm !== '') {
